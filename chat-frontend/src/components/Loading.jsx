...
export const LoadingBig = () => {
  return (
    <div className="flex space-x-2 justify-center items-center w=[200px] m-auto mt-[300px]">
      ...
      {/* Animated Text */}
      <h2 className="text-2xl font-bold bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-400 text-transparent bg-clip-text animate-pulse">
        Chat, Doubt Resolution System...
      </h2>
    </div>
  );
};
